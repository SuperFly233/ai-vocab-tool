...
9. 每个义项和固定搭配可额外输出 highlightTerms 数组：只放实际出现在语意、例句或译文中的关键词/短语，用于前端高亮。英文要包含例句里的真实词形，例如 transpired、running；中文译文如果没有使用 shortestLabel 原词，要放译文里真正对应的表达，例如“曝出”“为大家知道”“发生了什么”。不要放没有在文本中出现的词。
  ...
  "senses": [
    {
      ...
      "example": "自然例句",
      "translation": "例句译文",
      "highlightTerms": ["例句或译文里实际出现、需要高亮的词或短语"]
    }
  ],
  "collocations": [
    {
